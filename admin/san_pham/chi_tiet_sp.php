...
<div class="hien_thi"><button class=" btn btn-primary button">Thêm kích thước</button>
    <form class=" pt-9 px-9 form needs-validation" novalidate style="display: none;" action="index.php?act=chi_tiet_sp&id_sp=<?= $id_sp_dang_xem ?>&them_anh" method="post">

        <div class="mb-3 row">
            <div class="row mb-3 col-md-5">
                <label for="inputEmail3" class="col-sm-5 col-form-label">Kích thước có sẵn</label>
                <div class="col-sm-7">
                    <select class="form-select" required aria-label="Small select example" name="kich_thuoc">
...
<div class="hien_thi"><button class=" btn btn-primary button">Thêm màu sắc</button>
    <form class="pt-9 px-9 form needs-validation" novalidate style="display: none;" action="index.php?act=chi_tiet_sp&id_sp=<?= $id_sp_dang_xem ?>" method="post" enctype="multipart/form-data">

        <div class="mb-3 row">
            <div class="row mb-3 col-md-7">
                <div class="form-floating col-md-4">
                    <input name="ten_mau" type="text" required class="form-control" id="floatingInput" placeholder="">
                ...
                <div class="col-md-8"> 
                    <input name="anh_mau" required style="height: 58px;" class="form-control" type="file" id="formFileMultiple" multiple>
                    <div class="invalid-feedback">
                        Vui lòng thêm ảnh màu sắc
                    </div>
                </div>
            </div>
            <div class="col-md-5">
    ...
    <tbody>
        <?php foreach ($mau_sp as $value) : extract($value) ?>
            <tr>
                ...
                <td><a href="index.php?act=anh_theo_mau&id_mau=<?= $id_mau ?>&id_sp=<?= $id_sp_dang_xem ?>">Chi tiết</a></td>
